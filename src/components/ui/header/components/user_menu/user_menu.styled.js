...
export const StyledUserMenuWrapper = styled.div(({ $colors }) => ({
    display: "flex",
...
export const StyledUserMenuActionButton = styled.button(({ $colors }) => ({
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
...
export const StyledUserMenuLogin = styled.h3(({ $colors, $textColor }) => ({
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
