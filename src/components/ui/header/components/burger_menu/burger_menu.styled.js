...
export const StyledBurgerMenuWrapper = styled.ul(({ $colors }) => ({
    display: "flex",
...
export const StyledBurgerMenuNavLink = styled(NavLink)(({ $colors, $isactive, $isFavorites, $favoritesIsUnlock }) => ({
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    padding: "12px 16px",
