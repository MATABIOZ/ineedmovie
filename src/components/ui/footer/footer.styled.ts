...
export const StyledFooterWrapper = styled.div<IColorsProps>(({ $colors }) => ({
  display: "flex",
...
export const StyledFooterItemTitle = styled.h3<IColorsProps>(({ $colors }) => ({
  display: "flex",
  justifyContent: "center",
  alignItems: "center",
  borderRadius: "8px",
...
export const StyledFooterItemLogoText = styled.span<IColorsProps>(
  ({ $colors }) => ({
...
export const StyledFooterText = styled.p<IColorsProps>(({ $colors }) => ({
  width: "100%",
  color: $colors.subText,
  marginTop: "10px",
  paddingTop: "10px",
