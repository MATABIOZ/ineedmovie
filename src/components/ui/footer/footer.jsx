...
import { StyledFooter, StyledFooterItemContainer, StyledFooterItemLogoImg, StyledFooterItemLogoText, StyledFooterItemLogoTextWrapper, StyledFooterItemLogoWrapper, StyledFooterItemTitle, StyledFooterText, StyledFooterWrapper, } from "./footer.styled";
export const Footer = () => {
      ...
      <StyledContainer>
        <StyledFooterWrapper $colors={colors}>
          <StyledFooterItemContainer>
            ...
            <StyledFooterItemLogoWrapper to={"https://github.com/MATABIOZ/ineedmovie"}>
              <StyledFooterItemLogoImg src={themeType === "dark" ? GithubLogoLight : GithubLogoDark} alt="github"/>
            </StyledFooterItemLogoWrapper>
          </StyledFooterItemContainer>
          <StyledFooterItemContainer>
            <StyledFooterItemTitle $colors={colors}>Api:</StyledFooterItemTitle>
            <StyledFooterItemLogoWrapper to={"https://developer.themoviedb.org/"}>
