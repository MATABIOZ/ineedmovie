...
import { MEDIA_LAPTOP, MEDIA_LARGE_LAPTOP, MEDIA_MOBILE, } from "../../consts/media_vars";
export const StyledBannerWrapper = styled.div(({ $backgroundLink, $colors }) => ({
    display: "flex",
...
export const StyledBannerTitle = styled.h2(({ $colors }) => ({
    fontSize: 38,
    fontWeight: 700,
...
export const StyledBannerOverview = styled.p(({ $colors }) => ({
    fontSize: 18,
    fontWeight: 500,
    lineHeight: "150%",
