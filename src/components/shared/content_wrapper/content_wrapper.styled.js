...
export const StyledContentWrapper = styled.div(({ $colors }) => ({
    display: "flex",
...
export const StyledContentWrapperTitle = styled.h3(({ $colors }) => ({
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    borderRadius: "8px",
...
export const StyledContentWrapperHeaderItem = styled.h3(({ $colors, $isTotalResults }) => ({
