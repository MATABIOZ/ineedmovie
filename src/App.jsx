...
import { getGenres, getMovies, } from "./redux/reducers/content_reducer/content_reducer";
...
function App() {
    ...
    return (<StyledApp className="App" $colors={colors}>
      <Router>
        <Routes>
          ...
          <Route path="/authorisation/sign_up" element={<AuthorisationForm formFor={"sign_up"}/>}/>
          <Route path="/authorisation/sign_in" element={<AuthorisationForm formFor={"sign_in"}/>}/>
        </Routes>
      </Router>
      <ScrollToTopButton />
    </StyledApp>);
